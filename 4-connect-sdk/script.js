...
$(document).ready(() => {
    ...
    // const consumerKey = "idaGgUh5WH_dTqhYVCpTxQ==";
    // const consumerSecret = "XxRk9aNFdXcP2N26aPrfQlhwiWU-O_McVkO1K3uLiJg=";
    // const conferenceId = "44b94d38-eea0-4fd5-ab7a-44eeb39c39a2";
    ...
    // addVideoNode({ id: "1", info: { name: "Fabien Lavocat"}}, null);
    // addVideoNode({ id: "2", info: { name: "Guest Participant 1"}}, null);
    // addVideoNode({ id: "3", info: { name: "Guest Participant 2"}}, null);

    // addScreenShareNode(null);

    //addVideoPlayer('https://download.dolby.com/Dolby_Vision/kingdom-of-colors-v2.mp4');
});